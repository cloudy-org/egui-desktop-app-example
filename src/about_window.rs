...
impl<'a> AboutWindow<'a> {
    pub fn new() -> Self {
        let about_app_info = AboutApplicationInfo {
            ...
            webpage: "https://github.com/cloudy-org/egui-desktop-app-example".to_string(),
            git_repo: "https://github.com/cloudy-org/egui-desktop-app-example".to_string(),
            copyright: "Copyright (C) 2026 - 2026 Ananas".to_string()
        };

        let about_widget = About::new(
            crate::app::NIJIKA.clone(), about_app_info
        );
